...
/**
 * @OA\Schema(
 *     schema="UpdateStoreGroupRequest",
 *     @OA\Property(
 *         property="group_name",
 *         type="string",
 *         maxLength=200,
 ...
 * )
 */
class UpdateStoreGroupRequest extends FormRequest
{
    /**
    ...
    {
        $storeGroupId = $this->route('store_group');

        return [
            'group_name' => 'sometimes|string|max:200',
            'group_key' => [
                'sometimes',
                'string',
                'max:100',
                Rule::unique('store_groups', 'group_key')->ignore($storeGroupId, 'id_store_group'),
            ],
            'group_logo' => 'nullable|string|max:200',
            'first_name' => 'sometimes|string|max:200',
            'last_name' => 'sometimes|string|max:200',
            'is_sepa' => 'sometimes|integer|in:0,1',
        ];
    }
