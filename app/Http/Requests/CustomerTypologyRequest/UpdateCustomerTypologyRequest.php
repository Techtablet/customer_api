...
/**
 * @OA\Schema(
 *     schema="UpdateCustomerTypologyRequest",
 *     @OA\Property(
 *         property="name",
 *         type="string",
 *         maxLength=50,
 ...
 * )
 */
class UpdateCustomerTypologyRequest extends FormRequest
{
    /**
    ...
    {
        $customerTypologyId = $this->route('customer_typology');
        ...
        return [
            'name' => [
                ...
                'string',
                'max:50',
                Rule::unique('customer_typologies', 'name')->ignore($customerTypologyId, 'id_customer_typologie'),
            ],
        ];
    }
