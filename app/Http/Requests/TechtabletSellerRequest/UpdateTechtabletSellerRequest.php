...
/**
 * @OA\Schema(
 *     schema="UpdateTechtabletSellerRequest",
 *     @OA\Property(
 *         property="first_name",
 *         type="string",
 *         maxLength=50,
 ...
 * )
 */
class UpdateTechtabletSellerRequest extends FormRequest
{
    /**
    ...
    {
        $techtabletSellerId = $this->route('techtablet_seller');
        ...
        return [
            ...
            'email' => [
                ...
                'email',
                'max:150',
                Rule::unique('techtablet_sellers', 'email')->ignore($techtabletSellerId, 'id_techtablet_seller'),
            ],
            ...
            'employee_code' => [
                ...
                'string',
                'max:30',
                Rule::unique('techtablet_sellers', 'employee_code')->ignore($techtabletSellerId, 'id_techtablet_seller'),
            ],
