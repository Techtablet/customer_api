...
/**
 * @OA\Schema(
 *     schema="UpdateCustomerScheduleRequest",
 *     @OA\Property(
...
class UpdateCustomerScheduleRequest extends FormRequest
{
    ...
    public function rules(): array
    {
        return [
            ...
            'day' => 'sometimes|array|min:1',
            'day.*' => 'string|in:1,2,3,4,5,6,7',
            'opening_time' => 'sometimes|date_format:H:i',
            'closure_time' => 'sometimes|date_format:H:i|after:opening_time',
