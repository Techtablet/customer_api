...
/**
 * @OA\Schema(
 *     schema="StoreCustomerStatRequest",
 *     required={"id_customer"},
 *     @OA\Property(
 ...
 * )
 */
class StoreCustomerStatRequest extends FormRequest
{
    /**
    ...
    {
        return [
            'id_customer' => 'required|integer|exists:customers,id_customer|unique:customer_stats,id_customer',
    ...
    public function messages(): array
    {
        return [
            ...
            'id_customer.unique' => 'Des statistiques existent déjà pour ce client.',
