...
/**
 * @OA\Schema(
 *     schema="StoreCustomerContactRoleRequest",
 *     required={"name"},
 *     @OA\Property(
 *         property="name",
 *         type="string",
 ...
 * )
 */
class StoreCustomerContactRoleRequest extends FormRequest
{
    /**
    ...
    {
        return [
            'name' => 'required|string|max:50|unique:customer_contact_roles,name',
        ];
    }
