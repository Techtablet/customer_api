...
class UpdateCustomerRequest extends FormRequest
{
    ...
    public function rules(): array
    {
        return [
            ...
            'id_franchise' => 'sometimes|integer|exists:franchises,id_franchise',
            'id_stock_software' => 'sometimes|integer|exists:stock_softwares,id_stock_software',
            'to_callback' => 'sometimes|boolean',
            'id_status' => 'sometimes|integer|exists:customer_statuses,id_customer_status',
            'id_refusal_reason' => 'sometimes|integer|exists:customer_refusal_reasons,id_customer_refusal_reason',
            'survey_actif' => 'sometimes|integer|in:0,1',
            'survey_date_disabled' => 'sometimes|date',
            'important' => 'sometimes|integer|in:0,1',
            'notes' => 'nullable|string',
            'reminder' => 'nullable|date',
            'seller_reminder' => 'sometimes|integer',
            'id_seller' => 'sometimes|integer|exists:techtablet_sellers,id_techtablet_seller',
            ...
            'ape' => 'sometimes|string|max:20',
            'rcs' => 'sometimes|string|max:40',
            ...
            'last_website_key' => 'sometimes|string|max:500',
